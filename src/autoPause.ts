...
const AutoPauseModule = GObject.registerClass(
    ...
    class AutoPauseModule extends GObject.Object {
        ...
        /**
         * Watch a key for the module's lifetime. Handlers left connected after
         * disable() keep a dead module evaluating stale state, which then fights
         * the live one over the renderer's play/pause.
         *
         * @param {string} key - settings key to watch
         * @param {Function} callback - invoked when the key changes
         */
        protected watchSetting(key: string, callback: () => void): void {
        ...
        disable(): void {
            this.settingsIds.forEach(id => this.settings.disconnect(id));
            this.settingsIds = [];
        }
    }
);
...
const PauseOnMaximizeOrFullscreenModule = GObject.registerClass(
    class PauseOnMaximizeOrFullscreenModule extends AutoPauseModule {
        ...
        constructor(settings: Gio.Settings) {
            ...
            this.watchSetting('pause-on-maximize-or-fullscreen', () => {
...
const PauseOnFocusModule = GObject.registerClass(
    class PauseOnFocusModule extends AutoPauseModule {
        ...
        constructor(settings: Gio.Settings) {
            ...
            this.watchSetting('pause-on-focus', () => {
...
const PauseOnBatteryModule = GObject.registerClass(
    class PauseOnBatteryModule extends AutoPauseModule {
        ...
        private upowerChangedId: number | null;
        ...
        override disable(): void {
            if (this.upowerChangedId !== null) {
                this.upower.proxy.disconnect(this.upowerChangedId);
                this.upowerChangedId = null;
            }
            super.disable();
        }
...
const PauseOnMprisPlayingModule = GObject.registerClass(
    class PauseOnMprisPlayingModule extends AutoPauseModule {
        ...
        private nameOwnerChangedId: number | null;
        ...
        constructor(settings: Gio.Settings) {
            ...
            this.watchSetting('pause-on-mpris-playing', () => {
        ...
        override enable(): void {
            ...
            this.nameOwnerChangedId = this.dbus.proxy.connectSignal(
                'NameOwnerChanged',
                (
        ...
        override disable(): void {
            if (this.nameOwnerChangedId !== null) {
                this.dbus.proxy.disconnectSignal(this.nameOwnerChangedId);
                this.nameOwnerChangedId = null;
            }
